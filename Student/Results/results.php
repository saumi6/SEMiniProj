            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                  <a class="nav-link active" aria-current="page" href="./S1S.html">Sem 1</a>
                  <a class="nav-link" href="./S2S.html">Sem 2</a>
                  <!--<a class="nav-link" href="#">Sem 3</a>-->
                </div>
                <div class="dropdown py-2">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="./S1U1.html">Unit test 1</a></li>
                    <li><a class="dropdown-item" href="./S1U2.html">Unit test 2</a></li>
                    <li><a class="dropdown-item" href="./S1S.html">Semester exam</a></li>
                  </ul>
                </div>
              </div>
            </div>
